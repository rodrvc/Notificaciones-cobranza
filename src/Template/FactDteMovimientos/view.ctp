...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Fact Dte Movimiento'), ['action' => 'edit', $factDteMovimiento->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Fact Dte Movimiento'), ['action' => 'delete', $factDteMovimiento->id], ['confirm' => __('Are you sure you want to delete # {0}?', $factDteMovimiento->id)]) ?> </li>
...
<div class="factDteMovimientos view large-9 medium-8 columns content">
    <h3><?= h($factDteMovimiento->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($factDteMovimiento->fact_dtes)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($factDteMovimiento->fact_dtes as $factDtes): ?>
            <tr>
                <td><?= h($factDtes->id) ?></td>
