...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit General Comuna'), ['action' => 'edit', $generalComuna->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete General Comuna'), ['action' => 'delete', $generalComuna->id], ['confirm' => __('Are you sure you want to delete # {0}?', $generalComuna->id)]) ?> </li>
...
<div class="generalComunas view large-9 medium-8 columns content">
    <h3><?= h($generalComuna->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($generalComuna->general_maestro_personas)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($generalComuna->general_maestro_personas as $generalMaestroPersonas): ?>
            <tr>
