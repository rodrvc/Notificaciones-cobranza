...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Fact Dte Pago'), ['action' => 'edit', $factDtePago->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Fact Dte Pago'), ['action' => 'delete', $factDtePago->id], ['confirm' => __('Are you sure you want to delete # {0}?', $factDtePago->id)]) ?> </li>
...
<div class="factDtePagos view large-9 medium-8 columns content">
    <h3><?= h($factDtePago->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($factDtePago->fact_dtes)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <th scope="col"><?= __('Fact Sii Estado Id') ?></th>
            ...
            <?php foreach ($factDtePago->fact_dtes as $factDtes): ?>
            <tr>
                <td><?= h($factDtes->id) ?></td>
                ...
                <td><?= h($factDtes->fact_sii_estado_id) ?></td>
