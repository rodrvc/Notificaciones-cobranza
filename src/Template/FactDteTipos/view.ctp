...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Fact Dte Tipo'), ['action' => 'edit', $factDteTipo->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Fact Dte Tipo'), ['action' => 'delete', $factDteTipo->id], ['confirm' => __('Are you sure you want to delete # {0}?', $factDteTipo->id)]) ?> </li>
...
<div class="factDteTipos view large-9 medium-8 columns content">
    <h3><?= h($factDteTipo->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($factDteTipo->fact_dtes)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($factDteTipo->fact_dtes as $factDtes): ?>
            <tr>
                <td><?= h($factDtes->id) ?></td>
