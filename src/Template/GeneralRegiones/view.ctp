...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit General Regione'), ['action' => 'edit', $generalRegione->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete General Regione'), ['action' => 'delete', $generalRegione->id], ['confirm' => __('Are you sure you want to delete # {0}?', $generalRegione->id)]) ?> </li>
...
<div class="generalRegiones view large-9 medium-8 columns content">
    <h3><?= h($generalRegione->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($generalRegione->general_maestro_personas)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($generalRegione->general_maestro_personas as $generalMaestroPersonas): ?>
            <tr>
